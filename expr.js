 ...
 * ruleDeps).  "This" becomes the "details" property if it was
 * generated by a rule.  (Axioms, definitions and assumptions are not
 * generated by rules, though theorems are.)  The ruleArgs and
 * ruleDeps are both optional, and empty if not given.
 */
Expr.prototype.justify = function(ruleName, ruleArgs, ruleDeps) {
  ...
  expr._justify(ruleName, ruleArgs, ruleDeps);
  return expr;
};
