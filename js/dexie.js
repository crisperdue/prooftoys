...
function getSchemaDiff(oldSchema, newSchema) {
    ...
    for (table in newSchema) {
        ...
        if (!oldDef) {
            ...
            if (('' + (oldDef.primKey.keyPath || '')) !== ('' + (newDef.primKey.keyPath || '')) ||
        ...
        switch (op.type) {
            ...
            case 'put':
                ...
                modifedResult = result
                    .filter(function (item) { return !keySet_1.hasKey(req.values ? extractPrimKey(item) : item); })
                    .concat(req.values
                    ? includedValues
                    : includedValues.map(function (v) { return extractPrimKey(v); }));
                break;
...
var Dexie$1 = (function () {
    ...
    Dexie.prototype.open = function () {
        var _this = this;
        return usePSD(globalPSD, function () { return dexieOpen(_this); });
    };
