...
Prooftoys has the same theorems as Q_0_, and essentially the same axioms, with slight extensions to enable the boolean operators
...
IiwiaGlzdG9yeSI6WzE1NTg5NDEwMzYsODEwNzk2NzIzLC0yMD
